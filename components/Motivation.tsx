...
function Motivation() {
  return (
    <Box className='d-flex justify-content-center' style={{ height: '500px', backgroundColor: '#646e66' }}>
      <Box style={{ width: '50%' }}>
        <h2 className='display-4 heading font-weight-bold mt-3 mb-2 mx-5'>
          Why StyleShift?
        </h2>
      ...
      >
        <h2 className='display-4 font-weight-bold mt-3 mb-2 mx-5'>
